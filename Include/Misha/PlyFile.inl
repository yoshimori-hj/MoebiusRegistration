...
/* memory allocation */
char *my_alloc(size_t, int, const char *);
...
#define BIG_STRING 4096
...
#if PLY_STRIP_COMMENT_HEADER
		  if (*ptr == '\t' || *ptr == '\r') {
#else // !PLY_STRIP_COMMENT_HEADER
		  if (*ptr == '\r') {
#endif // PLY_STRIP_COMMENT_HEADER
			  *ptr = ' ';
			  *ptr2 = ' ';
		  }
		  else if (*ptr == '\n') {
  ...
  ******************************************************************************/
  ...
  char *my_alloc( size_t size, int lnum, const char *fname)
  {
	  char *ptr;
